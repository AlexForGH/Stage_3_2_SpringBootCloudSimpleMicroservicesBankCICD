# Stage_3_1_SpringBootCloudSimpleMicroservicesBank

![Демо работы](./demo.gif)

## *EN*
#### Link to the following Spring Boot project with CI/CD setup: https://github.com/AlexForGH/Stage_3_2_SpringBootCloudSimpleMicroservicesBankCICD.git
...
## *RU*
#### Ссылка на следующий Spring Boot проект с настройкой CI/CD: https://github.com/AlexForGH/Stage_3_2_SpringBootCloudSimpleMicroservicesBankCICD.git
